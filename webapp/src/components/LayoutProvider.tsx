        ...
        <Layout style={{ minHeight: '100vh' }}>
            <Sider width={250} onCollapse={() => setCollapsed(!collapsed)} collapsed={collapsed} style={{ background: colorBgContainer }}>
                <div style={{ height: 50, margin: 16 }}>
                    {
                        !collapsed ? <Image src={"/logo.png"} alt="pay" preview={false} width={150} /> : <Image src={"/ICON.png"} alt="pay" preview={false} width={50} height={50} />
                    }
                </div>
                ...
                <Menu
                    ...
                    items={[
                        ...
                        { type: "divider" },
                        {
                            key: "9",
                            type: "group",
                            label: !collapsed ? 'StreamPay v1.0.0' : "",
                            children: [
                                {
                                    key: '11',
                                    icon: <GithubOutlined />,
                                    label: 'Github',
                                    onClick: () => window.open("https://github.com/stream-protocol/streampay-platform", "_blank")
                                },
                                {
                                    key: '12',
                                    icon: <FaSuperscript />,
                                ...
                                },
                                {
                                    ...
                                    icon: <LiaDiscord />,
                                    label: 'Discord',
                                    onClick: () => window.open("https://discord.com/channels/", "_blank")
                                },
                            ]
                        }
                    ]}
            ...
            <Layout>
                ...
                <Footer style={{ textAlign: 'center', maxHeight: 50 }}>© 2023 StreamPayments. All Rights Reserved</Footer>
            </Layout>

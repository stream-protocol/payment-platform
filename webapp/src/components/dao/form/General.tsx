...
const General = () => {
    const initialValues = {
        title: '',
        description: '',
        dao_type: 1, // You can use a constant here
    };
    ...
    return (
        <Card title="Pick a DAO type and name it" headStyle={headStyle}>
            ...
            <Form.Item name="dao_type" initialValue={initialValues.dao_type}>
                <Radio.Group>
                    <Radio value={1}>Membership StreamDAO (Multisig)</Radio>
                    <Radio disabled value={2}>Token-based DAO (coming soon)</Radio>
                </Radio.Group>
            </Form.Item>
            <p><strong>Membership StreamDAO (Multisig):</strong> Small organization with a few members who are likely to stick around. Members can be added and removed by a vote of existing members.</p>
